...
pygame.display.set_caption("Cube Runner - Juice Edition")
...
def reset_game():
    ...
    return (
        player, [], 0, 0,
        0, 0,            # wall_cd, fake_cd
        False, 0, 0,     # boss_mode, timer, phase
        False,           # boss_done
        0, 0,            # shake_timer, intensity
        0                # flash_timer
    )
...
shake_timer, shake_intensity, flash_timer = reset_game()
    ...
    if game_state == PLAYING:
        ...
        for lane_x in LANES:
            pygame.draw.line(screen, (200, 200, 200),
                             (lane_x + offset_x, 0 + offset_y),
                             (lane_x + offset_x, HEIGHT + offset_y), 1)
